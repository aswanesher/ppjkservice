...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form class="form-horizontal" role="form" action="<?php echo base_url('laporan_po/laporan_po_update'); ?>" method="post" enctype="multipart/form-data"><div class="form-group">
